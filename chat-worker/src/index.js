...
แบบฝึกเขียนตอบ 20 ข้อ 210 คะแนน
- เป็นข้อสอบอัตนัยที่ต้องคำนวณ เขียนรายการบัญชี และอธิบายเหตุผลเอง
  แต่ละข้อมีโจทย์ ช่องเขียนคำตอบที่บันทึกไว้ในเครื่องผู้เรียนเอง เฉลยละเอียด และเกณฑ์ให้คะแนนแยกเป็นข้อ ๆ
- รูปแบบโจทย์ห้าแบบ คือ คำนวณหาตัวเลข บันทึกรายการบัญชี
  กระดาษทำการกระทบยอดและตารางไล่ยอด อธิบายวินิจฉัยให้เหตุผล และหาข้อผิดพลาด
- ข้อ 1 ถึง 5 บทที่ 1 ได้แก่ รายการค้าสองสมุด อุปกรณ์สี่กรณี กระทบยอดบัญชีระหว่างกันที่มีรายการบันทึกผิดปน
  กำไรส่วนเพิ่มในสินค้าสาขาที่ฐานอัตรากำไรคิดผิดบ่อย และค่าขนส่งส่วนเกินระหว่างสาขา
- ข้อ 6 ถึง 9 บทที่ 2 ได้แก่ ซื้อสินทรัพย์สุทธิโดยจ่ายด้วยหุ้นพร้อมค่าใช้จ่ายสองก้อนที่ปฏิบัติต่างกัน
  สิ่งตอบแทนที่คาดว่าจะต้องจ่ายกับกำไรจากการต่อรองราคาซื้อ ระยะเวลาในการวัดมูลค่า
  และการประเมินค่าความนิยมจากกำไรเกินปกติซึ่งใช้ต่อรองราคาเท่านั้น ห้ามบันทึกเป็นค่าความนิยม
- ข้อ 10 ถึง 12 บทที่ 3 ได้แก่ NCI สองวิธีวัดมูลค่าพร้อมรายการตัดบัญชี
  สินทรัพย์ถาวรที่ต้องล้างค่าเสื่อมราคาสะสม และการวินิจฉัยการควบคุมสามสถานการณ์รวมสิทธิที่อาจเกิดขึ้น
- ข้อ 13 ถึง 16 บทที่ 4 ได้แก่ ราคาทุนเทียบส่วนได้เสีย ตารางไล่ยอด NCI สามปีรวมกรณี NCI ติดลบ
  FVTPL เทียบ FVOCI ที่ห้ามจัดประเภทใหม่เมื่อขาย และบริษัทร่วมที่มีค่าความนิยมแฝง
- ข้อ 17 ถึง 18 ตัวอย่างครบวงจร ได้แก่ โจทย์ยาวปีแรกครบทุกขั้น และปีที่ผลต่างสะสมลดลงจนต้องเดบิตกำไรสุทธิ
- ข้อ 19 ถึง 20 รวมทุกบท ได้แก่ ถูกหรือผิดพร้อมเหตุผลหกข้อ และทฤษฎีความเป็นหน่วยงานเทียบความเป็นเจ้าของ
`.trim(),
  },
  audit: {
    name: "การสอบบัญชี",
...
แบบฝึกฟัง Part III · 5 ชุด 10 คลิป 100 ข้อ
- ทำตามแนวข้อสอบจริง แต่ละชุดมี Listening 1 การนำเสนอกลุ่มเรื่อง international marketing
  ที่มีผู้พูดหลายคน และ Listening 2 การบรรยายกรณี merger ที่มีผู้พูดคนเดียว ชุดละ 20 คะแนน
- หัวข้อของทั้งห้าชุด คือ เข้าตลาดเวียดนาม กับ Kraft ซื้อ Cadbury · พากาแฟเข้าญี่ปุ่น
  กับ Disney ซื้อ Pixar · เปิดตัวสกินแคร์ในบราซิล กับ ข้อเสนอซื้อที่ล้มเหลว ·
  เปลี่ยนตำแหน่งสายการบินต้นทุนต่ำ กับ management buyout ของโรงพิมพ์ ·
  ผลวิจัยตลาดอินโดนีเซีย กับ กิจการร่วมค้าผลิตแบตเตอรี่
- คำถามเน้นฟังจับรายละเอียดโดยเฉพาะตัวเลข แต่ละคลิปมีตัวเลขใกล้เคียงกันหลายตัวเป็นตัวลวง
- มีบทพูดให้เปิดดูหลังทำเสร็จ พร้อมไฮไลต์ตามเสียงที่กำลังเล่น และกดที่บรรทัดเพื่อกระโดดไปฟังตรงนั้นได้

ข้อสอบเสมือนจริง 5 ชุด ชุดละ 40 คะแนน ข้อละ 1 คะแนน
- แท็บข้อสอบเสมือนจริงมี Part I Vocabulary 10 คะแนน และ Part II Language Points 10 คะแนน
  แล้วข้ามไปทำ Part III Listening อีก 20 คะแนนในแท็บฝึกฟังชุดเดียวกัน
- Part I A ศัพท์การตลาด และ Part I B ศัพท์ merger กับ acquisition
  เป็นแบบเลือกวลีจากกล่องคำมาเติมให้ประโยคสมบูรณ์ กล่องคำมี 8 วลี ใช้จริง 5 ข้อ ที่เหลือเป็นตัวลวง
- Part II A ตัดสินว่าวลีนามเรียงคำถูกหรือผิด ถ้าผิดจะเฉลยรูปที่ถูกให้
  จำนวนข้อที่เรียงถูกในแต่ละชุดไม่เท่ากัน เพื่อไม่ให้เดาคำตอบเดียวรวดแล้วได้คะแนนฟรี
- Part II B เลือกรูปกริยาคาดการณ์ที่ถูกต้อง สี่ตัวเลือก
- ตัวเลือกและลำดับในกล่องคำสลับใหม่ทุกครั้งที่กดเริ่มทำใหม่
- ของจริงตอบลงกระดาษคำตอบคอมพิวเตอร์ด้วยดินสอ 2B

คลังคำศัพท์ 129 คำ
- แท็บคำศัพท์รวมศัพท์ทั้งสองหน่วยไว้ที่เดียว แบ่งเป็น 12 หมวด
  คือ คำคู่ 5 กลุ่มหลัก · compound noun · ตลาดและส่วนของตลาด · การวิจัยตลาด ·
  เปิดตัวและส่งเสริมการขาย · ช่องทางจำหน่าย · adverb ในวลีนาม · วลีนามจากบทความ ·
  ตัวย่อ · หกคำหลักของ M&A · กริยาที่ใช้คู่กัน · ศัพท์ M&A เพิ่มเติม
- ค้นหาได้ทั้งคำอังกฤษ คำแปลไทย และคำอธิบาย กรองตามหน่วยและหมวดได้
  มีโหมดท่องที่ซ่อนคำแปลไว้ และติ๊กคำที่จำได้แล้วเพื่อให้เหลือเฉพาะคำที่ต้องทบทวน
