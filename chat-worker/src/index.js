...
ตัวอย่างครบวงจร ต่อเนื่องสองปีและกรณีบริษัทร่วม
- โจทย์เดียวไล่ตั้งแต่วันซื้อหุ้น ผ่านปีที่ 1 ปีที่ 2 จนถึงกรณีมีบริษัทร่วม
  ถือหุ้น 90% จ่าย 360,000 บวกค่าใช้จ่ายในการซื้อหุ้น 6,000 ส่วนของผู้ถือหุ้น 250,000
- ผลต่างมูลค่ายุติธรรมสี่รายการที่ตัดบัญชีไม่เหมือนกัน คือสินค้าคงเหลือที่ขายหมดในปีเดียว
  ที่ดินที่ไม่ตัดจำหน่าย อาคารที่เพิ่มค่าเสื่อม และอุปกรณ์ที่มูลค่ายุติธรรมต่ำกว่าบัญชี
  จึงต้องลดค่าเสื่อมและบวกกลับเข้ากำไร
- ค่าความนิยม 45,000 จากสิ่งตอบแทน 360,000 บวก NCI 35,000 หักสินทรัพย์สุทธิ 350,000
  โดยค่าใช้จ่ายในการซื้อหุ้นไม่นับเป็นสิ่งตอบแทนและต้องรับรู้เป็นค่าใช้จ่ายทันที
- รายการตัดบัญชีสี่รายการ ณ วันซื้อหุ้น ที่ล้างเงินลงทุน 366,000 ให้เหลือศูนย์
- ปีที่ 1 กำไรบริษัทย่อยที่ปรับแล้ว 51,000 แบ่ง NCI 5,100 และบริษัทใหญ่ 149,900
  โดย NCI ต้องคิดจากกำไรที่ปรับรายการตัดจำหน่ายแล้ว ไม่ใช่กำไรดิบ
- การปรับเงินลงทุนจากวิธีราคาทุนเป็นวิธีส่วนได้เสีย ทั้งสองวิธีคำนวณให้ผลเท่ากันที่ 387,900
  ผลต่าง 21,900 ในปีแรกลงกำไรสุทธิทั้งก้อนเพราะยังไม่มีกำไรสะสมต้นงวด
- ปีที่ 2 ผลต่างสะสม 85,800 แยกเป็นกำไรสะสมต้นงวด 21,900 และกำไรสุทธิปีนี้ 63,900
  โดยสินค้าคงเหลือหายไปจากรายการปรับเพราะขายหมดตั้งแต่ปีแรก
- รูปแบบทั่วไปปีที่ 1 ถึง 4 และกรณีที่ผลต่างสะสมลดลงจนต้องเดบิตกำไรสุทธิ
- สูตรผลต่างสะสม เท่ากับ %ถือหุ้น คูณ ผลต่างกำไรสะสมของบริษัทย่อยหักรายการตัดจำหน่ายสะสม
  แล้วหักค่าใช้จ่ายในการซื้อหุ้น โดยใช้กำไรสะสมเพราะผลต่างกำไรสะสมเท่ากับกำไรสุทธิหักเงินปันผลจ่ายพอดี
- กรณีถือบริษัทย่อย 80% และบริษัทร่วม 30% พร้อมกัน ค่าความนิยมของบริษัทร่วม 3,000
  ที่ไม่แยกแสดงเพราะรวมอยู่ในบรรทัดเงินลงทุน ส่วนแบ่งกำไร 30% ของกำไรที่ปรับแล้ว 17,000 เท่ากับ 5,100
- ความต่างที่สำคัญที่สุด ทั้งสองกรณีตัดเงินปันผลรับออกเหมือนกัน
  แต่บริษัทย่อยนำรายได้ค่าใช้จ่ายทุกบรรทัดมารวมแล้วแสดง NCI
  ส่วนบริษัทร่วมแสดงเพียงส่วนแบ่งกำไรบรรทัดเดียว
`.trim(),
  },
  audit: {
    name: "การสอบบัญชี",
...
และหัวข้องานให้ความเชื่อมั่นกับบริการเกี่ยวเนื่อง พร้อมหลักจรรยาบรรณตามประมวลของ IESBA
...
- ภูมิทัศน์สี่ชั้น คือ assurance engagements, attestation engagements,
  financial statement audit และ related services โดยกลุ่มสุดท้ายไม่ให้ความเชื่อมั่นใด ๆ
- reasonable assurance ใช้กับงานตรวจสอบ ให้ผลเป็นความเห็นในรูปบวกตาม ISA 700
  ส่วน limited assurance ใช้กับงานสอบทานตาม ISRE หรือ TSRE 2410
  ให้ผลเป็นข้อสรุปในรูปลบว่าไม่พบสิ่งที่เป็นเหตุให้เชื่อว่า
- สี่ประเภทงานและความเป็นอิสระ โดยการตรวจสอบและการสอบทานต้องเป็นอิสระ
  AUP ตาม ISRS 4400 ไม่ให้ความเชื่อมั่นแต่ยังต้องเป็นอิสระและเปิดเผยเรื่องความเป็นอิสระ
  ส่วน compilation ตาม ISRS 4410 ไม่ให้ความเชื่อมั่นและไม่จำเป็นต้องเป็นอิสระ
  แต่ยังต้องปฏิบัติตามประมวลจรรยาบรรณของ IESBA
- วิธีการของงานสอบทานห้าอย่าง และรูปแบบรายงานสี่แบบ คือข้อสรุปมาตรฐาน
  ข้อสรุปอย่างมีเงื่อนไข การไม่แสดงข้อสรุป และวรรคเน้นเรื่อง
  โดยเส้นแบ่งคือมีสาระสำคัญ เทียบกับ มีสาระสำคัญและแพร่กระจาย
- งาน AUP รายงาน factual findings โดยห้ามตีความและห้ามสรุป
- special audit ที่ทำนอกเหนือการตรวจสอบตามกฎหมาย พร้อมกรณีศึกษาบริษัทจดทะเบียนไทย
  ที่มีรายได้แสดงเกินจริง รายการค้าที่ไม่มีอยู่จริง และการยักยอกทรัพย์สิน
  รวมถึงสัญญาณเตือนห้าข้อและการล้มล้างการควบคุมโดยผู้บริหาร
- มาตรฐานอื่น ได้แก่ ISAE 3000, 3400, 3402 ที่มี Type 1 กับ Type 2, 3420 และ 3410
  โดย 3410 จะถูกแทนด้วย ISSA หรือ TSSA 5000 ซึ่งมีผล 15 ธันวาคม 2026
- ESG assurance ที่ส่วนใหญ่ยังเป็นความเชื่อมั่นอย่างจำกัด และมาตรฐานใหม่
  ISA 240 ปรับปรุง กับ ISA 570 ปรับปรุง 2024 ซึ่งมีผลสำหรับรอบบัญชีที่เริ่มในหรือหลัง 15 ธันวาคม 2026

จรรยาบรรณตามประมวลของ IESBA เพิ่มเติมจากของ AICPA
- หลักการพื้นฐานห้าข้อ คือ integrity, objectivity,
  professional competence and due care, confidentiality และ professional behaviour
  โดยความเป็นอิสระไม่ได้อยู่ในห้าข้อนี้ เพราะเป็นข้อกำหนดแยกต่างหาก
- หน้าที่รักษาความลับอยู่ต่อแม้ความสัมพันธ์กับลูกค้าจบแล้ว
  และแม้ข้อมูลนั้นจะกลายเป็นข้อมูลสาธารณะไปแล้ว
- กรอบแนวคิดที่ต้องมีจิตใจช่างสงสัยใคร่รู้ ใช้ดุลยพินิจเยี่ยงผู้ประกอบวิชาชีพ
  และใช้ reasonable and informed third party test
- การจัดการภัยคุกคามสามทาง คือขจัดสถานการณ์ ใช้มาตรการป้องกัน หรือปฏิเสธงาน
- ภัยคุกคามห้าประเภทของ IESBA คือ self-interest, self-review, advocacy,
  familiarity และ intimidation ซึ่งต่างจาก AICPA ที่มีเจ็ดประเภท
  โดยสิ่งที่ AICPA เรียก undue influence นั้น IESBA เรียก intimidation
- สองกรณีที่ไม่มีมาตรการป้องกันใดใช้ได้ คือ self-review threat ต่อลูกค้าที่เป็น PIE
  ซึ่งห้ามโดยไม่ต้องพิจารณาสาระสำคัญ และ advocacy ในข้อพิพาทที่จำนวนเงินมีสาระสำคัญ
